...
#define ERROR_SECURITY_KM_RKP_LOGIC                0x800015AA  /* return when km RKP logic's error occurs. */
#define ERROR_SECURITY_NO_CLOCK                    0x800015AB  /* return when module has no clock. */
